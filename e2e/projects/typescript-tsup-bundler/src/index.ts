...
if (typeof createAPIClientMjs !== 'undefined') {
  console.log('Client is imported successfully from tsup project.');
} else {
  console.error('Client is not imported from tsup project.');
  process.exit(1);
}

if (typeof callbacks !== 'undefined') {
  console.log('Callbacks are imported successfully from tsup project.');
} else {
  console.error('Callbacks are not imported from tsup project.');
  process.exit(1);
}

if (typeof callbacksIndex !== 'undefined') {
  console.log('Callbacks index is imported successfully from tsup project.');
} else {
  console.error('Callbacks index is not imported from tsup project.');
  process.exit(1);
}

if (typeof useMutation !== 'undefined') {
  console.log('useMutation is imported successfully from tsup project.');
} else {
  console.error('useMutation is not imported from tsup project.');
  process.exit(1);
}

if (typeof useQuery !== 'undefined') {
  console.log('useQuery is imported successfully from tsup project.');
} else {
  console.error('useQuery is not imported from tsup project.');
  process.exit(1);
}

if (typeof createSecureRequestFn !== 'undefined') {
  console.log(
    'createSecureRequestFn is imported successfully from tsup project.'
  );
} else {
  console.error('createSecureRequestFn is not imported from tsup project.');
  process.exit(1);
}

if (typeof QraftSecureRequestFn !== 'undefined') {
  console.log(
    'QraftSecureRequestFn is imported successfully from tsup project.'
  );
} else {
  console.error('QraftSecureRequestFn is not imported from tsup project.');
  process.exit(1);
}
