      ...
      expect(output).toMatchInlineSnapshot(`
        ...
        Options:
          ...
          --file-header <string>               Header to be added to the generated file
                                               ...
                                               @qraft/cli.\\n * Do not make direct
                                               changes to the file.\\n */\\n\\n")
          --redocly [config]                   Use the Redocly configuration to generate
                                               multiple API clients
                                               If the [config] parameter is not
                                               specified, the default Redocly
                                               configuration will be used: [redocly.yaml
                                               | redocly.yml | .redocly.yaml |
                                               .redocly.yml].
                                               For more information about this option,
                                               use the command: --redocly-help
                                               Examples:
                                               $ bin --redocly
                                               $ bin my-api --redocly
                                               $ bin my-api@v1 my-api@v2 --redocly
    ...
    it('should display help with asyncapi-typescript plugin', async () => {
      ...
      expect(output).toMatchInlineSnapshot(`
        ...
        Options:
          ...
          --redocly [config]                 Use the Redocly configuration to generate
                                             multiple API clients
                                             If the [config] parameter is not specified,
                                             the default Redocly configuration will be
                                             used: [redocly.yaml | redocly.yml |
                                             .redocly.yaml | .redocly.yml].
                                             For more information about this option, use
                                             the command: --redocly-help
                                             Examples:
                                             $ bin --redocly
                                             $ bin my-api --redocly
                                             $ bin my-api@v1 my-api@v2 --redocly
