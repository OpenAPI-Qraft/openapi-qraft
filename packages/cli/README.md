...
Options:
  ...
  --filter-services <glob-pattern>                Filter services to be generated by glob pattern. Eg: "/user/**,/post/**". See NPM `micromatch` package for more
                                                  details.
  --operation-predefined-parameters <patterns...>  Predefined parameters for services. The specified services parameters will be optional. Eg:
                                                   "/**:header.x-monite-version,query.x-api-key.;/user/**,/post/**:header.x-monite-entity-id"
...
- **`--operation-predefined-parameters <patterns...> `:** Predefined parameters for services. The specified services parameters will be optional. _(optional)_
  ...
  - Examples:
    ...
    - `--operation-predefined-parameters '/**:header.x-monite-version,query.x-api-key' '/user/**,/post/**:header.x-monite-entity-id'` -
      ...
      > **Note:** In future versions of the library, this feature will be expanded. Not only will it make parameters optional,
      > but it will also offer typed suggestions for these predefined parameters when creating a client. This enhancement will
