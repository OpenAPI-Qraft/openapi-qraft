import type transformer from '../migrate-to-v2.4.0-codemod.js';
import path from 'node:path';
import { describe, expect, it } from 'vitest';

describe('migrate-to-v2.4.0-codemod', () => {
  const transformPath = path.resolve('./src/migrate-to-v2.4.0-codemod.ts');
  const genericsFixturePath =
    './src/tests/fixtures/migrate-to-v2.4.0-codemod/generics.tsx';
  const otherImportsFixturePath =
    './src/tests/fixtures/migrate-to-v2.4.0-codemod/other-imports.tsx';
  const mixedImportsFixturePath =
    './src/tests/fixtures/migrate-to-v2.4.0-codemod/mixed-imports.tsx';
  const customPackageFixturePath =
    './src/tests/fixtures/migrate-to-v2.4.0-codemod/custom-package.tsx';
