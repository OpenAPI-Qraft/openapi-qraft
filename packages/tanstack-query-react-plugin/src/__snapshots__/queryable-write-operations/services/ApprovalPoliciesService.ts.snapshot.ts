...
export interface ApprovalPoliciesService {
    ...
    deleteApprovalPoliciesId: {
         ...
         * @example Query with parameters
         * ```ts
         * const { data, isLoading } = qraft.approvalPolicies.deleteApprovalPoliciesId.useQuery({
         *     header: {
         *         "x-monite-version": "2023-06-04",
         *         "x-monite-entity-id": xMoniteEntityId
         *     },
         ...
         * @example Infinite Query
         * ```ts
         * const { data, isLoading, fetchNextPage } = qraft.approvalPolicies.deleteApprovalPoliciesId.useInfiniteQuery({
         *     header: {
         *         "x-monite-version": "2023-06-04",
         *         "x-monite-entity-id": xMoniteEntityId
         *     },
         ...
         * ```
         */
        useInfiniteQuery<TPageParam extends DeleteApprovalPoliciesIdParameters, TQueryFnData = DeleteApprovalPoliciesIdData, TData = OperationInfiniteData<TQueryFnData, DeleteApprovalPoliciesIdParameters>>(parameters: ServiceOperationInfiniteQueryKey<DeleteApprovalPoliciesIdSchema, DeleteApprovalPoliciesIdParameters> | (DeepReadonly<DeleteApprovalPoliciesIdParameters>), options: Omit<DefinedInitialDataInfiniteOptions<TQueryFnData, DeleteApprovalPoliciesIdError, TData, ServiceOperationInfiniteQueryKey<DeleteApprovalPoliciesIdSchema, DeleteApprovalPoliciesIdParameters>, PartialParameters<DeepReadonly<TPageParam>>>, "queryKey" | "getPreviousPageParam" | "getNextPageParam" | "initialPageParam"> & InfiniteQueryPageParamsOptions<TQueryFnData, PartialParameters<DeepReadonly<TPageParam>>>): DefinedUseInfiniteQueryResult<TData, OperationError<DeleteApprovalPoliciesIdError>>;
        /**
         * Performs asynchronous data fetching with support for infinite scrolling scenarios.
         * Manages paginated data and provides utilities for fetching additional pages.
         *
         ...
         * both normal and infinite. If no parameters are provided, no filtering is applied.
         * ```ts
         * const deleteApprovalPoliciesIdTotal = qraft.approvalPolicies.deleteApprovalPoliciesId.useIsFetching()
         * ```
         * @example Checks the number of normal queries fetching with the specified parameters.
         * ```ts
         * const deleteApprovalPoliciesIdByParametersTotal = qraft.approvalPolicies.deleteApprovalPoliciesId.useIsFetching({
         *     infinite: false,
         *     parameters: {
         *         header: {
         *             "x-monite-version": "2023-06-04",
         ...
         * @example Multiple queries. Returns `data`, `error`, `isSuccess` and other properties.
         * ```ts
         * const deleteApprovalPoliciesIdResults = qraft.approvalPolicies.deleteApprovalPoliciesId.useQueries({
         *     queries: [
         *         {
         *             header: {
         *                 "x-monite-version": "2023-06-04",
         ...
         * @example Combined results. Only the data will be returned.
         * ```ts
         * const deleteApprovalPoliciesIdCombinedResults = qraft.approvalPolicies.deleteApprovalPoliciesId.useQueries({
         *     combine: results => results.map(result => result.data),
         *     queries: [
         *         {
         *             header: {
         ...
         * @example Suspense Query with parameters
         * ```ts
         * const data = qraft.approvalPolicies.deleteApprovalPoliciesId.useSuspenseQuery({
         *     header: {
         *         "x-monite-version": "2023-06-04",
         *         "x-monite-entity-id": xMoniteEntityId
         *     },
         ...
         * @example Suspense Infinite Query
         * ```ts
         * const { data, isLoading, fetchNextPage } = qraft.approvalPolicies.deleteApprovalPoliciesId.useSuspenseInfiniteQuery({
         *     header: {
         *         "x-monite-version": "2023-06-04",
         *         "x-monite-entity-id": xMoniteEntityId
         *     },
         ...
         * ```
         */
        useSuspenseInfiniteQuery<TPageParam extends DeleteApprovalPoliciesIdParameters, TData = DeleteApprovalPoliciesIdData>(parameters: ServiceOperationInfiniteQueryKey<DeleteApprovalPoliciesIdSchema, DeleteApprovalPoliciesIdParameters> | (DeepReadonly<DeleteApprovalPoliciesIdParameters>), options: Omit<UseSuspenseInfiniteQueryOptions<DeleteApprovalPoliciesIdData, DeleteApprovalPoliciesIdError, OperationInfiniteData<TData, DeleteApprovalPoliciesIdParameters>, ServiceOperationInfiniteQueryKey<DeleteApprovalPoliciesIdSchema, DeleteApprovalPoliciesIdParameters>, PartialParameters<DeepReadonly<TPageParam>>>, "queryKey" | "getPreviousPageParam" | "getNextPageParam" | "initialPageParam"> & InfiniteQueryPageParamsOptions<DeleteApprovalPoliciesIdData, PartialParameters<DeepReadonly<TPageParam>>>): UseSuspenseInfiniteQueryResult<OperationInfiniteData<TData, DeleteApprovalPoliciesIdParameters>, OperationError<DeleteApprovalPoliciesIdError>>;
        /**
         * Allows you to execute multiple asynchronous data fetching operations concurrently with Suspense support.
         * Similar to useQueries but integrates with React Suspense for loading states.
         *
         ...
         * @example Basic usage with Suspense
         * ```ts
         * const deleteApprovalPoliciesIdData = qraft.approvalPolicies.deleteApprovalPoliciesId.useSuspenseQueries({
         *     queries: [
         *         {
         *             header: {
         *                 "x-monite-version": "2023-06-04",
         ...
         * @example With data transformation using combine
         * ```ts
         * const deleteApprovalPoliciesIdCombinedData = qraft.approvalPolicies.deleteApprovalPoliciesId.useSuspenseQueries({
         *     combine: results => results.map(result => result.data),
         *     queries: [
         *         {
         *             header: {
    ...
    patchApprovalPoliciesId: {
         ...
         * @example Query with parameters
         * ```ts
         * const { data, isLoading } = qraft.approvalPolicies.patchApprovalPoliciesId.useQuery({
         *     body: queryBody,
         *     header: {
         *         "x-monite-version": "2023-06-04",
         *         "x-monite-entity-id": xMoniteEntityId
         ...
         * @example Infinite Query
         * ```ts
         * const { data, isLoading, fetchNextPage } = qraft.approvalPolicies.patchApprovalPoliciesId.useInfiniteQuery({
         *     body: queryBody,
         *     header: {
         *         "x-monite-version": "2023-06-04",
         *         "x-monite-entity-id": xMoniteEntityId
         ...
         * both normal and infinite. If no parameters are provided, no filtering is applied.
         * ```ts
         * const patchApprovalPoliciesIdTotal = qraft.approvalPolicies.patchApprovalPoliciesId.useIsFetching()
         * ```
         * @example Checks the number of normal queries fetching with the specified parameters.
         * ```ts
         * const patchApprovalPoliciesIdByParametersTotal = qraft.approvalPolicies.patchApprovalPoliciesId.useIsFetching({
         *     infinite: false,
         *     parameters: {
         *         body: queryBody,
         *         header: {
         ...
         * @example Multiple queries. Returns `data`, `error`, `isSuccess` and other properties.
         * ```ts
         * const patchApprovalPoliciesIdResults = qraft.approvalPolicies.patchApprovalPoliciesId.useQueries({
         *     queries: [
         *         {
         *             body: queryBody1,
         *             header: {
         ...
         * @example Combined results. Only the data will be returned.
         * ```ts
         * const patchApprovalPoliciesIdCombinedResults = qraft.approvalPolicies.patchApprovalPoliciesId.useQueries({
         *     combine: results => results.map(result => result.data),
         *     queries: [
         *         {
         *             body: queryBody1,
         ...
         * @example Suspense Query with parameters
         * ```ts
         * const data = qraft.approvalPolicies.patchApprovalPoliciesId.useSuspenseQuery({
         *     body: queryBody,
         *     header: {
         *         "x-monite-version": "2023-06-04",
         *         "x-monite-entity-id": xMoniteEntityId
         ...
         * @example Suspense Infinite Query
         * ```ts
         * const { data, isLoading, fetchNextPage } = qraft.approvalPolicies.patchApprovalPoliciesId.useSuspenseInfiniteQuery({
         *     body: queryBody,
         *     header: {
         *         "x-monite-version": "2023-06-04",
         *         "x-monite-entity-id": xMoniteEntityId
         ...
         * @example Basic usage with Suspense
         * ```ts
         * const patchApprovalPoliciesIdData = qraft.approvalPolicies.patchApprovalPoliciesId.useSuspenseQueries({
         *     queries: [
         *         {
         *             body: queryBody1,
         *             header: {
         ...
         * @example With data transformation using combine
         * ```ts
         * const patchApprovalPoliciesIdCombinedData = qraft.approvalPolicies.patchApprovalPoliciesId.useSuspenseQueries({
         *     combine: results => results.map(result => result.data),
         *     queries: [
         *         {
         *             body: queryBody1,
