...
export function createAPIOperationClient<Services extends UnionServiceOperationsDeclaration<Services>, Callbacks extends Partial<AllCallbacks> = DefaultCallbacks>(services: Services, options: Context<CreateAPIQueryClientOptions>, callbacks?: Callbacks): APIContextQueryClientServices<Services, Callbacks>;
