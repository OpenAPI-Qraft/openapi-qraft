    ...
    [
      {
        ...
        code: `
            ...
            function Component() {
                const { mutate } = qraft.service.operation.useMutation({ mutationFn: (value: string) => value });
      ...
      useQueryHookNames.map((queryHook) => ({
        ...
        code: `
            ...
            function Component() {
              const { refetch } = qraft.service.operation.${queryHook}({ queryFn: (value: string) => value });
    ...
    [
      {
        ...
        code: `
            ...
            function Component() {
              const mutation = qraft.service.operation.useMutation({ mutationFn: (value: string) => value });
        ...
        errors: [
          {
            messageId: 'noUnstableDeps' as const,
      ...
      useQueryHookNames.map((queryHook) => ({
        ...
        code: `
            ...
            function Component() {
              const query = qraft.service.operation.${queryHook}({ queryFn: (value: string) => value });
