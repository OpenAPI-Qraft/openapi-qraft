...
<Tabs>
  ...
  <TabItem value="witout-filters" label={<span style={{verticalAlign: "middle"}}>No <code style={{textDecoration: "line-through"}}>filters</code>, <code style={{textDecoration: "line-through"}}>options</code></span>}>
    Refetches _all_ queries for the specified endpoint.
...
<Tabs>
  ...
  <TabItem value="without-filters" label={<span style={{verticalAlign: "middle"}}><code style={{textDecoration: 'line-through'}}>filters</code></span>}>
     ...
     **/
    qraft.entities.getEntities.refetchQueries(queryClient);
    ```
  </TabItem>
  ...
  <TabItem value="only-infinite" label={<span style={{verticalAlign: "middle"}}>Only <em>Infinite</em></span>}>
    Using predicate to refetch only _Infinite Queries_:
