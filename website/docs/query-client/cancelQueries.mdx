...
<Tabs>
  <TabItem value="with-filters-no-options" label={<span style={{verticalAlign: "middle"}}><code>filters</code>, <code style={{textDecoration: "line-through"}}>options</code></span>}>
  ...
  <TabItem value="with-filter-and-options" label={<span style={{verticalAlign: "middle"}}><code>filters</code>, <code>options</code></span>}>
  ...
  <TabItem value="witout-filters" label={<span style={{verticalAlign: "middle"}}><code style={{textDecoration: "line-through"}}>filters</code>, <code style={{textDecoration: "line-through"}}>options</code></span>}>
    Cancels _all_ queries for the specified endpoint.
...
<Tabs>
  ...
  <TabItem value="without-filters" label={<span style={{verticalAlign: "middle"}}><code style={{textDecoration: 'line-through'}}>filters</code></span>}>
    ...
    ```ts
    /**
     * Will cancel the queries matching the specified endpoint:
     * ###
     * GET /entities/3e3e-3e3e-3e3e
     * x-monite-version: 2023-09-01
     * ###
  ...
  <TabItem value="with-predicate" label={<span style={{verticalAlign: "middle"}}><code>predicate</code></span>}>
    ...
    ```ts
    /**
     * Will cancel the queries matching the specified endpoint and predicate:
     * ###
     * GET /entities/3e3e-3e3e-3e3e
     * x-monite-version: 2023-09-01
     **/
  ...
  <TabItem value="only-infinite" label={<span style={{verticalAlign: "middle"}}>Only <em>Infinite</em></span>}>
    Using predicate to cancel only _Infinite Queries_:
