...
- **[OpenAPI mode](/codegen/CLI/openapi/)** (`qraft openapi`) — generates code from OpenAPI documents with OpenAPI plugins.
...
- [OpenAPI mode (`qraft openapi`)](/codegen/CLI/openapi/)
