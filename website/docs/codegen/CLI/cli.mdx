...
- **[AsyncAPI mode](/codegen/CLI/asyncapi/index.mdx)** (`qraft asyncapi`) — enables generation from AsyncAPI documents with AsyncAPI plugins.
...
- [AsyncAPI mode (`qraft asyncapi`)](/codegen/CLI/asyncapi/index.mdx)
