...
See the TanStack [_useIsFetching(...) 🌴_](https://tanstack.com/query/latest/docs/framework/react/reference/useIsFetching) documentation for more details.
...
1. `filters?: QueryFiltersByParameters | QueryFiltersByQueryKey`
   ...
   - `filters.queryKey: QueryKey` will be used for filtering queries by instead of parameters
