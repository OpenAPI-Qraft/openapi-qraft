...
See the [OpenAPI Authentication 🔗](https://swagger.io/docs/specification/authentication/) specification for more information.
...
- `queryClient?: QueryClient` - **Optional** [_QueryClient 🌴_](https://tanstack.com/query/latest/docs/reference/QueryClient)
